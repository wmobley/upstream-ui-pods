...
import { useList as useProjectsList } from '../../../../hooks/projects/useList';
...
const CreateCampaignForm: React.FC<CreateCampaignFormProps> = ({ onCancel }) => {
  ...
  // Create unique projects list by title to avoid duplicates
  ...
  return (
    <QueryWrapper isLoading={projectsLoading} error={projectsError}>
          ...
          <div>
            ...
            >
              ...
              {uniqueProjects.map((project) => (
                <option key={project.chargeCode} value={project.chargeCode}>
                  {project.title}
                </option>
              ))}
            </select>
