...
export function AggregatedMeasurementFromJSONTyped(json: any, ignoreDiscriminator: boolean): AggregatedMeasurement {
    ...
    return {
        ...
        'parametricLowerBound': json['parametric_lower_bound'] == null ? undefined : json['parametric_lower_bound'],
        'parametricUpperBound': json['parametric_upper_bound'] == null ? undefined : json['parametric_upper_bound'],
