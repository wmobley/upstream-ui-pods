 ...
 * @export
 */
export type GetStationResponseGeometry = { type: 'GeometryCollection' } & GeometryCollection | { type: 'LineString' } & LineString | { type: 'MultiLineString' } & MultiLineString | { type: 'MultiPoint' } & MultiPoint | { type: 'MultiPolygon' } & MultiPolygon | { type: 'Point' } & Point | { type: 'Polygon' } & Polygon;

export function GetStationResponseGeometryFromJSON(json: any): GetStationResponseGeometry {
    return GetStationResponseGeometryFromJSONTyped(json, false);
}

export function GetStationResponseGeometryFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetStationResponseGeometry {
    if (json == null) {
        return json;
    }
    switch (json['type']) {
        ...
        default:
            throw new Error(`No variant of GetStationResponseGeometry exists with 'type=${json['type']}'`);
    }
}

export function GetStationResponseGeometryToJSON(json: any): any {
    return GetStationResponseGeometryToJSONTyped(json, false);
}

export function GetStationResponseGeometryToJSONTyped(value?: GetStationResponseGeometry | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    switch (value['type']) {
        ...
        default:
            throw new Error(`No variant of GetStationResponseGeometry exists with 'type=${value['type']}'`);
    }
