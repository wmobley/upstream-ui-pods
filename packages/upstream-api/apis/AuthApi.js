...
var AuthApi = /** @class */ (function (_super) {
     ...
     * Login
     */
    AuthApi.prototype.loginApiV1TokenPostRaw = function (requestParameters, initOverrides) {
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters['username'] == null) {
                            throw new runtime.RequiredError('username', 'Required parameter "username" was null or undefined when calling loginApiV1TokenPost().');
                        }
                        if (requestParameters['password'] == null) {
                            throw new runtime.RequiredError('password', 'Required parameter "password" was null or undefined when calling loginApiV1TokenPost().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        consumes = [
     ...
     * Login
     */
    AuthApi.prototype.loginApiV1TokenPost = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loginApiV1TokenPostRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
